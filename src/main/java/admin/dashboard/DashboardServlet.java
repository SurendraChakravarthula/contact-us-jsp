...
import contact_us.ContactUsRequestDao;
import contact_us.RequestDao;

@WebServlet(name = "AdminDashboard", urlPatterns = "/dashboard")
public class DashboardServlet extends HttpServlet {

	private RequestDao requestDao = new ContactUsRequestDao();
	...
	protected void doGet(HttpServletRequest httpRequest, HttpServletResponse httpResponse) {
		...
		List<User> activeRequests = requestDao.fetchAllRequests(true);
		List<User> archiveRequests = requestDao.fetchAllRequests(false);
